...
$ignoreErrors[] = [
    'message' => '#^Method OpenEMR\\\\Core\\\\OEHttpKernel\\:\\:getEventDispatcher\\(\\) should return Symfony\\\\Contracts\\\\EventDispatcher\\\\EventDispatcherInterface but returns mixed\\.$#',
    'count' => 1,
